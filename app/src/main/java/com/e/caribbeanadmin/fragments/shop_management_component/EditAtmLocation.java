...
public class EditAtmLocation extends Fragment {

    private ShopLocation updateShopLocation;
    private Shop shop;
    private FragmentEditAtmLocationBinding mDataBinding;
    private Uri imageUri;

    public EditAtmLocation() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_edit_atm_location, container, false);
