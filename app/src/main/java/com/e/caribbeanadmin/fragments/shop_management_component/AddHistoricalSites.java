...
import com.e.caribbeanadmin.databinding.FragmentAddHistoricalSitesBinding;
...
public class AddHistoricalSites extends Fragment {


    private Uri imageUri;
    private Shop shop;
    private AddDealsBinding dealsBinding;
    private FragmentAddHistoricalSitesBinding mDataBinding;
    private static final String TAG = "AddHistoricalSites";
    public AddHistoricalSites() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_add_historical_sites, container, false);
        ...
        Repository.getShopItems(shop.getId(), DatabaseAddresses.getHistoricalCollection(), new OnItemLoadListeners() {
            ...
            public void onItemLoaded(List<Item> itemList) {
                ...
                DealsAdaptor adaptor=new DealsAdaptor(getContext(),itemList,DatabaseAddresses.getHistoricalCollection());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    DatabaseUploader.publishItem(item, DatabaseAddresses.getHistoricalCollection(), new OnTaskCompleteListeners() {
                                        @Override
