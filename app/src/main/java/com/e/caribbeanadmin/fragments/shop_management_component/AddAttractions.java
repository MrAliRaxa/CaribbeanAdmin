...
import com.e.caribbeanadmin.databinding.FragmentAddAttractionsBinding;
...
public class AddAttractions extends Fragment {

    private Uri imageUri;
    private Shop shop;
    private AddDealsBinding dealsBinding;
    private FragmentAddAttractionsBinding mDataBinding;
    private static final String TAG = "AddAttractions";
    public AddAttractions() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_add_attractions, container, false);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    DatabaseUploader.publishItem(item, DatabaseAddresses.getAttractionsCollection(), new OnTaskCompleteListeners() {
                                        @Override
