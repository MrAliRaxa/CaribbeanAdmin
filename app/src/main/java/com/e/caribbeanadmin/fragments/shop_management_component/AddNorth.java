...
import com.e.caribbeanadmin.databinding.FragmentAddNorthBinding;
...
public class AddNorth extends Fragment {

    private Uri imageUri;
    private Shop shop;
    private AddDealsBinding dealsBinding;
    private FragmentAddNorthBinding mDataBinding;
    private static final String TAG = "AddNorth";
    public AddNorth() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_add_north, container, false);
        ...
        Repository.getShopItems(shop.getId(), DatabaseAddresses.getNorthCollection(), new OnItemLoadListeners() {
            ...
            @Override
            public void onEmpty() {
                mDataBinding.addNorthMsg.setVisibility(View.VISIBLE);
            }

            @Override
            public void onFailure(String e) {
                mDataBinding.addNorthMsg.setVisibility(View.VISIBLE);
                mDataBinding.addNorthMsg.setText("Error "+e);
            }
        });
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    DatabaseUploader.publishItem(item, DatabaseAddresses.getNorthCollection(), new OnTaskCompleteListeners() {
                                        @Override
