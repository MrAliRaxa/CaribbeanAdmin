...
import com.e.caribbeanadmin.databinding.FragmentAddTabagoBinding;
...
public class AddTobago extends Fragment {

    private Uri imageUri;
    private Shop shop;
    private AddDealsBinding dealsBinding;
    private FragmentAddTabagoBinding mDataBinding;
    private static final String TAG = "AddTobago";
    public AddTobago() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_add_tabago, container, false);
        ...
        Repository.getShopItems(shop.getId(), DatabaseAddresses.getTobagoCollection(), new OnItemLoadListeners() {
            ...
            @Override
            public void onEmpty() {
                mDataBinding.addTobagoMsg.setVisibility(View.VISIBLE);
            }

            @Override
            public void onFailure(String e) {
                mDataBinding.addTobagoMsg.setVisibility(View.VISIBLE);
                mDataBinding.addTobagoMsg.setText("Error "+e);
            }
        });
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    DatabaseUploader.publishItem(item, DatabaseAddresses.getTobagoCollection(), new OnTaskCompleteListeners() {
                                        @Override
