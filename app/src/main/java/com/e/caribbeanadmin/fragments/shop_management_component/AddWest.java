...
import com.e.caribbeanadmin.databinding.FragmentAddWestBinding;
...
public class AddWest extends Fragment {

    private Uri imageUri;
    private Shop shop;
    private AddDealsBinding dealsBinding;
    private FragmentAddWestBinding mDataBinding;
    private static final String TAG = "AddWest";
    public AddWest() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_add_west, container, false);
        ...
        Repository.getShopItems(shop.getId(), DatabaseAddresses.getWestCollection(), new OnItemLoadListeners() {
            ...
            public void onItemLoaded(List<Item> itemList) {
                mDataBinding.addWestRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                DealsAdaptor adaptor=new DealsAdaptor(getContext(),itemList,DatabaseAddresses.getWestCollection());
                mDataBinding.addWestRecyclerView.setAdapter(adaptor);
            }

            @Override
            public void onEmpty() {
                mDataBinding.addWestMsg.setVisibility(View.VISIBLE);
            }

            @Override
            public void onFailure(String e) {
                mDataBinding.addWestMsg.setVisibility(View.VISIBLE);
                mDataBinding.addWestMsg.setText("Error "+e);
            }
        });
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    DatabaseUploader.publishItem(item, DatabaseAddresses.getWestCollection(), new OnTaskCompleteListeners() {
                                        @Override
